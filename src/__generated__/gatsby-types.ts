...
type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpages404Tsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpages404Tsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };

type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesindexTsx2239478271QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesindexTsx2239478271Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
...
type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrccomponentsseoTsx2841359383QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrccomponentsseoTsx2841359383Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
...
type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrccomponentsseoJs2841359383QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrccomponentsseoJs2841359383Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description'>
      & { readonly social: Maybe<Pick<Social, 'twitter'>> }
    )> }> };

type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpages404Js3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpages404Js3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesindexJs2239478271QueryVariables = Exact<{ [key: string]: never; }>;


type usersyuskenakajimasourceWebstormProjectsgatsbyTypscriptSamplesrcpagesindexJs2239478271Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
      & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'date' | 'title' | 'description'>> }
    )> } };
